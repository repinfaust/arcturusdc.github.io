export const metadata = {
  title: 'Sprocket: Calm Phone Helper - Terms of Use',
  description: 'Sprocket: Calm Phone Helper Terms of Use and End User Licence Agreement (EULA).',
};

export default function TermsOfUsePage() {
  return (
    <main className="prose prose-neutral mx-auto px-4 md:px-6 lg:px-8 py-8">
      <h1>Sprocket: Calm Phone Helper - Terms of Use &amp; End User Licence Agreement (EULA)</h1>
      <p><strong>Last updated:</strong> February 2026</p>
      <p><strong>Applies to:</strong> Sprocket: Calm Phone Helper iOS app</p>
      ...
      <h2>1. About Sprocket: Calm Phone Helper</h2>
      <p>
        Sprocket: Calm Phone Helper is an AI-assisted voice and text assistant designed to help people with everyday
        tasks on their smartphone. It is provided by Arcturus Digital Consulting, registered in England and Wales.
      </p>

      <h2>2. Using Sprocket: Calm Phone Helper</h2>
      <p><strong>What Sprocket: Calm Phone Helper is for:</strong></p>
      <p>
        Sprocket: Calm Phone Helper is for personal, non-commercial use. You may use it to ask questions, set reminders,
        store personal notes, get step-by-step help with your phone, and understand confusing messages.
      </p>
      <p><strong>What Sprocket: Calm Phone Helper is not:</strong></p>
      <p>
        Sprocket: Calm Phone Helper is not a substitute for professional medical, legal, or financial advice.
        Replies are for general information only.
      </p>
      <p><strong>Emergency situations:</strong></p>
      <p>
        Sprocket: Calm Phone Helper is not an emergency service. If you or someone else is in danger,
      ...
      <h3>3.1 Free use</h3>
      <p>
        Sprocket: Calm Phone Helper is free to download and use. New users can try Sprocket: Calm Phone Helper free without signing in
      ...
      <p>
        To continue using Sprocket: Calm Phone Helper after your free questions are used, you can purchase
      ...
      <p>Sprocket: Calm Phone Helper uses OpenAI&apos;s AI to generate replies. You agree not to use Sprocket: Calm Phone Helper to:</p>
      <ul>
      ...
      <p>
        Sprocket: Calm Phone Helper responses are generated by AI and may sometimes be inaccurate, incomplete, or out of date.
      ...
      <p>
        We aim to keep Sprocket: Calm Phone Helper reliable, but cannot guarantee uninterrupted service.
        AI functionality depends on OpenAI availability.
      </p>

      <h2>8. Updates and changes</h2>
      <p>
        We may update Sprocket: Calm Phone Helper to improve features, fix issues, or comply with legal and platform requirements.
