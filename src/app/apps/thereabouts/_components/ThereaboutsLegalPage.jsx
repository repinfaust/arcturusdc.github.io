...
export default function ThereaboutsLegalPage({ eyebrow, title, updated = '10 August 2026', children }) {
  return (
    <main className="mx-auto max-w-4xl px-4 py-8 md:px-6 lg:px-8">
      <header className="border border-[#D7CEBC] bg-[#FFFDF8] p-5 md:p-7">
        ...
        <p className="mt-4 border-t border-[#D7CEBC] pt-4 text-sm text-[#686C62]">
          <strong>Last updated:</strong> {updated} · <strong>Status:</strong> private iOS and Android development build
        </p>
      </header>
