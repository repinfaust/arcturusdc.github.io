...
export const metadata = {
  ...
  description:
    "How to delete your SyncFit account and associated data. In-app deletion steps, alternative email method, what we delete, and retention timelines.",
  ...
  return (
    <main className="pb-10 px-4 max-w-3xl mx-auto">
      <header className="mt-6 mb-4">
        <h1 className="text-2xl font-extrabold">SyncFit — Delete Account &amp; Data</h1>
        <p className="text-muted text-sm mt-2">
          Official instructions for deleting your SyncFit account and associated data.
      ...
      <section className="card p-4 space-y-3">
        ...
        <p className="text-sm text-muted">
          If you signed in with Google, revoking access in your Google settings is optional but recommended.
        </p>
      </section>
      ...
      <section className="card p-4 mt-4 space-y-3">
        ...
        <p className="text-sm text-muted">
          ...
          where required by law; these are not used for any other purpose and are automatically purged on schedule.
        </p>
      </section>
