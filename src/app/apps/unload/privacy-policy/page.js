export const metadata = {
  title: 'Unload – Privacy Policy',
  description: 'Read the Unload privacy policy in HTML. Arcturus Digital Consulting Ltd.',
};

export default function PrivacyPolicyPage() {
  return (
    <main className="prose prose-neutral mx-auto px-4 md:px-6 lg:px-8 py-8">
      <h1>Unload — Privacy Policy</h1>
      ...
      <p>
        ...
        protects information when you use the <strong>Unload</strong> mobile
      ...
      <ul>
        <li>
          <strong>On-device app data (no account required):</strong> entries, labels,
          preferences, and session data are stored locally on your device. This
          information does not leave your device unless you choose to back it up via
          your device/OS features or share it with us (e.g., by email).
        </li>
        <li>
      ...
      <ul>
        <li>To operate core features (voice or text-based unloading on your device).</li>
